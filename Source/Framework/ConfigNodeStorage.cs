...
{ 
    public abstract class SM_ConfigNodeStorage : IPersistenceLoad, IPersistenceSave
    {
        #region Constructors
        /// <summary>
        /// Class Constructor
        /// </summary>
        public SM_ConfigNodeStorage() { }
        /// <summary>
        /// Class Constructor
        /// </summary>
        ...
        public SM_ConfigNodeStorage(String FilePath) { this.FilePath = FilePath; }
        #endregion
