...
namespace ScienceParamModifier.Framework
{
    ...
    /// </summary>
    public static class SM_UnityExtensions
    {
        /// <summary>
		...
		public static float Mathf_Round(this float f, int precision)
		{
			if (precision < -4 || precision > 4)
				throw new ArgumentOutOfRangeException("[Science Value Modifier] Precision Must Be Between -4 And 4 For Rounding Operation");
